          ...
          <Flex className="flexContainer">
            <Box className="allCon sellerImgBox bestSeller flex  rounded-xl justify-between">
              <Box className="flex sellerInfo  flex-col gap-2">
                ...
                <Text color="#6C62DF" className="price" fs={"26px"} fw={600}>
                  $48.9k
                </Text>
                <Box>
            ...
            <Box
              h={"100%"}
              className=" flex flex-col largeCon statCon allCon justify-between h-full"
            >
              <Flex className="justify-between statistics">
                <Text className="allConTitle " color="#5b5865">
                  Statistics
                </Text>
                <Text className="allConSubText" color="#5b5865">
                  Updated 1 month ago
                </Text>
              </Flex>
              <Flex className="justify-between statisticsNo">
                <Box className="flex statBox items-center gap-2">
                  <Box
                    className=" w-11 h-full rounded-md flex justify-center items-center"
                    bg={"#3A3B64"}
                    color="#655CCE"
                  >
                  ...
                  <Box className="flex flex-col gap-1">
                    <Text fz={"20px"} lh={1} fw={600} color="#5b5865">
                      230k
                    </Text>
                    <Text fz={"13px"} color="#8D8DA3" fw={600}>
                      Budgets
                    </Text>
                  </Box>
                </Box>
              ...
              <Flex className="gap-5 chartGrp">
                <Box className="w-1/2 flex profitChart flex-col justify-between gap-2 allCon">
                  ...
                  <Flex
                    ...
                    mt={"10px"}
                  >
                    <Text fz={"25px"} color="#5b5865">
                      654K
                    </Text>
                    <Text fz={"14px"} color="green">
                      +8.24%
                    </Text>
                  </Flex>
                </Box>
                <Box className="w-1/2 profitChart flex flex-col justify-between allCon">
                  ...
                  <Box className="radiusChart">{/* <Expenses/> */}</Box>
                  <Text className="allConSubText  clatext-center " mt={"10px"}>
